...
describe('backend-plugin-manager', () => {
  describe('loadPlugins', () => {
    ...
    type TestCase = {
      ...
      checkLoadedPlugins: (loadedPlugins: DynamicPlugin[]) => void;
    };
            ...
            errors: [
              {
                ...
                meta: {
                  ...
                  message: `Cannot find module '${url.fileURLToPath(
                    location,
                  )}/dist/index.cjs.js' from 'manager/plugin-manager.ts'`,
      ...
      },
      {
        ...
        expectedLogs(location) {
          return {
            errors: [
              {
                message: `dynamic backend plugin 'backend-dynamic-plugin-test' could not be loaded from '${location}': no exported 'dynamicPluginInstaller' field`,
              },
            ],
          };
        },
